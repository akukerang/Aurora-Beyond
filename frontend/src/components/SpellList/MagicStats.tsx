...
interface Props {
  classMagic: character.spells[];
}

const MagicStats: FC<Props> = ({ classMagic }) => {
  ...
  return (
    <div className="flex flex-row justify-center gap-6">
      <div className="flex flex-col justify-center">
        <h1 className="text-lg text-center font-semibold">Save DC</h1>
        <div className="text-lg text-center">{saveDC}</div>
      </div>
      <div className="flex flex-col justify-center">
        <h1 className="text-lg text-center font-semibold">Spell Attack</h1>
